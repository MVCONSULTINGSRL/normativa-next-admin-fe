...
export const BLUE_SEC = '#1e3b9f';
export const BLUE_DARK_TEXT_COLOR = '#1e3b9f';

export const DARK_BLUE = 'dark_blue';
export const DARK_BLUE_SEC = '#1e3b9f';
export const DARK_BLUE_DARK_TEXT_COLOR = '#1e3b9f';
...
export const LIGHT_BLUE_SEC = '#1e3b9f';
export const LIGHT_BLUE_DARK_TEXT_COLOR = '#1e3b9f';
