...
import {searchAllerte, showSpinner }from "../../../appRedux/actions";

import {disabledDate} from "../../../constants/Functions"

function NormativaSearchAllerte(props) {
    ...
    const onFinish = (searchFilters) => {
        ...
        dispatch(searchAllerte(searchFilters));
    };
    const onReset = () => {
        form.resetFields();
    };
    ...
    const searchFilters = useSelector(({allerteStore}) => allerteStore.searchFilters);
    useEffect(() => {
...
export default NormativaSearchAllerte;