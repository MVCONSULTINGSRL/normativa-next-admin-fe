...
import {searchRitiri, showSpinner} from "../../../appRedux/actions";

import {disabledDate} from "../../../constants/Functions"

function NormativaSearchRitiri(props) {
    ...
    const searchFilters = useSelector(({ritiriStore}) => ritiriStore.searchFilters);
    useEffect(() => {
...
export default NormativaSearchRitiri;