...
function NormativaSearchNorme(props) {
    ...
    const searchFilters = useSelector(({normeStore}) => normeStore.searchFilters);
    useEffect(() => {
        ...
        <Collapse>
            <Panel header="Ricerca" key="1">
                <Form
                    ...
                    <Row>
                        <Col span={12}>
                            <Form.Item name={'anno'} label="Anno:">
                                <Select
                                    showSearch
...
export default NormativaSearchNorme;