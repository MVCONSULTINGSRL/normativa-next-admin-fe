...
import {showSpinner, statisticheFrodi} from "../../../appRedux/actions";
...
function SearchFormFrodi() {
    ...
    const onFinish = (searchFilters) => {
        ...
        if (mandatoryField === undefined || mandatoryField.length === 0) {
            ...
            //console.log("--- SEARCH FORM Frodi - search dispatched - ", searchFilters)
            dispatch(statisticheFrodi(searchFilters));
            dispatch(showSpinner("Generazione statistica frodi in corso"));
        }
...
export default SearchFormFrodi;