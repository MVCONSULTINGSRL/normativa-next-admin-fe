...
import {showSpinner, statisticheRitiri} from "../../../appRedux/actions";
...
function SearchFormRitiri() {
    ...
    const onFinish = (searchFilters) => {
        ...
        if (mandatoryField === undefined || mandatoryField.length === 0) {
            ...
            dispatch(statisticheRitiri(searchFilters));
            dispatch(showSpinner("Generazione statistica richiami in corso"));
...
export default SearchFormRitiri;